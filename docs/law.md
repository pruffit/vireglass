...
`src/law.ts` holds every calibrated number in the material — 121 of them, in 20 groups —
...
Today that last line reads **43 of 121**. That is the real state of the model, and it is meant to
